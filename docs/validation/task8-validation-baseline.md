...
- Automated evidence: `docs/porting/task6-arch-platform-boundary.md`,
  ...
  `scripts/check_multiarch_host_gui.sh`, `scripts/check_aarch64_virt.sh`,
  `scripts/check_riscv64_virt.sh` and
...
4. confirm the `HOME` page exposes a focusable `DETAIL MODE` toggle and that
