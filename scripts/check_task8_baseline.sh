...
require_file "${ROOT_DIR}/arch/aarch64/README.md" "ARM64 architecture bring-up notes present"
require_file "${ROOT_DIR}/arch/riscv64/README.md" "RISC-V architecture bring-up notes present"
require_file "${ROOT_DIR}/platform/aarch64_virt/README.md" "ARM64 platform bring-up notes present"
require_file "${ROOT_DIR}/platform/riscv64_virt/README.md" "RISC-V platform bring-up notes present"
